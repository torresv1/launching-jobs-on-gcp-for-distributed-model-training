...
ZONE=$(curl --silent http://metadata.google.internal/computeMetada/v1/instance/attributes/zone -H "Metadata-Flavor: Google"
...
MLFLOW_TRACKING_URI=$(curl --silent http://metadata.google.internal/computeMetada/v1/instance/attributes/mlflow_tracking_uri -H "Metadata-Flavor: Google"
NODE_COUNT=$(curl --silent http://metadata.google.internal/computeMetada/v1/instance/attributes/node_count -H "Metadata-Flavor: Google"
DISKS=$(curl --silent http://metadata.google.internal/computeMetada/v1/instance/attributes/disks -H "Metadata-Flavor: Google"
